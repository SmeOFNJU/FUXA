...
!(function(a, b) {
  ...
  return (b = function(d) {
    ...
    stringToNumber: function(a) {
      ...
      if (h.zeroFormat && a === h.zeroFormat) c = 0;
        ...
        (c *=
          ...
          2
            ? 1
            : -1), (a = a.replace(/[^0-9\.]+/g, "")), (c *= Number(a));
      }
      return c;
    },
    isNaN: function(a) {
    ...
    toFixed: function(a, b, c, d) {
      ...
      return (e =
        2 === i.length
          ? Math.min(Math.max(i[1].length, j), b)
          : j), (g = Math.pow(10, e)), (h = (c(a + "e+" + e) / g).toFixed(
        e
      )), d > b - e &&
        (
  ...
  }), (b.options = h), (b.formats = e), (b.locales = f), (b.locale = function(
    a
  ) {
    ...
    return (f = j.currency.symbol), (h = j.abbreviations), (d =
      j.delimiters.decimal), (e =
      "." === j.delimiters.thousands
        ? "\\."
        : j.delimiters.thousands), (k = a.match(/^[^\d]+/)), null !== k &&
    ((a = a.substr(1)), k[0] !== f)
      ? !1
      : (
          (k = a.match(/[^\d]+$/)),
    ...
    subtract: function(a) {
      ...
      var d = c.correctionFactor.call(null, this._value, a);
      return (this._value =
        c.reduce([a], b, Math.round(this._value * d)) / d), this;
    },
    multiply: function(a) {
      function b(a, b, d, e) {
    ...
    b.register("format", "bps", {
      ...
      format: function(a, c, d) {
        ...
        return (a = 1e4 * a), (c = c.replace(
          /\s?BPS/,
          ""
        )), (e = b._.numberToFormat(a, c, d)), b._.includes(e, ")")
          ? ((e = e.split("")), e.splice(-1, 0, f + "BPS"), (e = e.join("")))
          : (e = e + f + "BPS"), e;
      },
      unformat: function(a) {
    ...
    b.register("format", "currency", {
      ...
      format: function(a, c, d) {
        ...
        for (
          c = c.replace(/\s?\$\s?/, ""), e = b._.numberToFormat(a, c, d), a >= 0
            ? (
              ...
              e =
                g === i.after.length - 1
                  ...
                  : b._.insert(
                      e,
                      " ",
                      -(i.after.length - (1 + g) + h.currency.symbol.length - 1)
                    );
          }
        return e;
      }
    ...
    b.register("format", "exponential", {
      ...
      format: function(a, c, d) {
        var e,
          ...
          g = f.split("e");
        return (c = c.replace(/e[\+|\-]{1}0/, "")), (e = b._.numberToFormat(
          Number(g[0]),
          c,
          d
        )), e + "e" + g[1];
      ...
      unformat: function(a) {
        ...
        var d = b._.includes(a, "e+") ? a.split("e+") : a.split("e-"),
          e = Number(d[0]),
          f = Number(d[1]);
        return (f = b._.includes(a, "e-") ? (f *= -1) : f), b._.reduce(
          [e, Math.pow(10, f)],
          c,
          1
        );
    ...
    b.register("format", "ordinal", {
      ...
      format: function(a, c, d) {
        var e,
          ...
          g = b._.includes(c, " o") ? " " : "";
        return (c = c.replace(/\s?o/, "")), (g += f.ordinal(
          a
        )), (e = b._.numberToFormat(a, c, d)), e + g;
      }
    });
  })(), (function() {
    b.register("format", "percentage", {
      ...
      format: function(a, c, d) {
        var e,
          f = b._.includes(c, " %") ? " " : "";
        return b.options.scalePercentBy100 && (a = 100 * a), (c = c.replace(
          /\s?\%/,
          ""
        )), (e = b._.numberToFormat(a, c, d)), b._.includes(e, ")")
    ...
    b.register("format", "time", {
      ...
      unformat: function(a) {
        ...
        return 3 === b.length
          ...
          : 2 === b.length &&
            ((c += 60 * Number(b[0])), (c += Number(b[1]))), Number(c);
      }
    });
  })(), b;
});
