!(function(t, e) {
  ...
  return (function(t) {
      ...
      (i = [r(3)]), void 0 ===
        (n = function(t) {
          function e(i) {
            ...
            if (e.is(i, T))
              return e._engine.create
                [c](e, i.splice(0, 3 + e.is(i[0], A)))
                .add(i);
            ...
            Q = (e.mapPath = function(t, e) {
              ...
              for (n = 0, s = (t = At(t)).length; n < s; n++)
                for (a = 1, o = (l = t[n]).length; a < o; a += 2)
                  (r = e.x(l[a], l[a + 1])), (i = e.y(l[a], l[a + 1])), (l[
                    a
                  ] = r), (l[a + 1] = i);
              return t;
            });
          ...
          (e.svg = !(e.vml =
            "VML" == e.type)), (e._Paper = u), (e.fn = i = u.prototype =
            e.prototype), (e._id = 0), (e.is = function(t, e) {
          ...
          e.setWindow = function(r) {
            t("raphael.setWindow", e, l.win, r), (l.win = r), (l.doc =
              l.win.document), e._engine.initWin && e._engine.initWin(l.win);
          };
          var it = function(t) {
              if (e.vml) {
                var r,
                    ...
                    return (
                      ...
                      ("000000" +
                        (e =
                          ((255 & e) << 16) |
                          (65280 & e) |
                          ((16711680 & e) >>> 16)).toString(16)).slice(-6)
                    );
                  } catch (t) {
                    return "none";
                  }
                ...
                (s.title = "Raphaël Colour Picker"), (s.style.display =
                  "none"), l.doc.body.appendChild(s), (it = ht(function(t) {
          ...
          (e.color = function(t) {
            ...
            return this.is(t, "object") &&
              ...
              "s" in t &&
              "b" in t &&
              ((r = t.b), (e = t.s), (i = t.o), (t = t.h)), (o =
              (l = r * e) *
              (1 - B((t = (t *= 360) % 360 / 60) % 2 - 1))), (n = a = s =
              r - l), lt(
              (n += [l, o, 0, 0, o, l][(t = ~~t)]),
              (a += [o, l, l, o, 0, 0][t]),
              (s += [0, 0, o, l, l, o][t]),
            ...
            return this.is(t, "object") &&
              ...
              "s" in t &&
              "l" in t &&
              ((r = t.l), (e = t.s), (t = t.h)), (t > 1 || e > 1 || r > 1) &&
              ((t /= 360), (e /= 100), (r /= 100)), (t =
              (t *= 360) % 360 / 60), (o =
              (l = 2 * e * (r < 0.5 ? r : 1 - r)) *
              (1 - B(t % 2 - 1))), (n = a = s = r - l / 2), lt(
              (n += [l, o, 0, 0, o, l][(t = ~~t)]),
              (a += [o, l, l, o, 0, 0][t]),
              (s += [0, 0, o, l, l, o][t]),
              i
            ...
            var i, n, a, s;
            return (t = (r = ot(t, e, r))[0]), (e = r[1]), (r = r[2]), (i =
              ((n = w(t, e, r)) + (a = k(t, e, r))) / 2), {
              h:
                ((0 == (s = n - a)
                  ? null
                  : n == t
          ...
          e._preload = function(t, e) {
            ...
            (r.style.cssText =
              "position:absolute;left:-9999em;top:-9999em"), (r.onload = function() {
          ...
          (e.getRGB = ht(function(t) {
                  ...
                  h[5]
                    ? (
                        ...
                        ("deg" == l[0].slice(-3) || "°" == l[0].slice(-1)) &&
                          (r /= 360),
                        "hsba" == h[1].toLowerCase().slice(0, 4) &&
                          (a = z(l[3])),
                        l[3] && "%" == l[3].slice(-1) && (a /= 100),
                        e.hsb2rgb(r, i, n, a)
                      )
            ...
            var i = {
              ...
              n = [];
            return e.is(t, T) && e.is(t[0], T) && (n = mt(t)), n.length ||
            ...
            if (!t) return null;
            var r = [];
            return e.is(t, T) && e.is(t[0], T) && (r = mt(t)), r.length ||
          ...
          var ft = function(t) {
            ...
            return e[t]
              ? (e[t].sleep = 100)
              : (e[t] = { sleep: 100 }), setTimeout(function() {
              for (var r in e)
          ...
          function gt(t, e, r, i, n, a, s, o) {
            if (
              ...
              if (l) {
                var h =
                    ((t * i - e * r) * (n - s) - (t - r) * (n * o - a * s)) / l,
                  u =
                    ((t * i - e * r) * (a - o) - (e - i) * (n * o - a * s)) / l,
                  c = +h.toFixed(2),
                  f = +u.toFixed(2);
                if (
                  !(
                  ...
                  if ("M" == b[0]) (s = u = b[1]), (o = c = b[2]);
                    ...
                    if (i) d += _;
                      ...
                      for (var w = 0, k = _.length; w < k; w++)
                        (_[w].segment1 = g), (_[w].segment2 = y), (_[
                          w
                        ].bez1 = f), (_[w].bez2 = p);
                      d = d.concat(_);
                    }
          ...
          var yt = (e.pathBBox = function(t) {
              ...
              for (
                ...
                if ((i.push((h = [])), (u = t[p])[0] != R.call(u[0])))
                  switch (((h[0] = R.call(u[0])), h[0])) {
                    case "A":
                      (h[1] = u[1]), (h[2] = u[2]), (h[3] = u[3]), (h[4] =
                        u[4]), (h[5] = u[5]), (h[6] = +(u[6] + n)), (h[7] = +(
                        u[7] + a
                      ));
                      break;
                    case "V":
            ...
            Bt = function(t, e, r, i, n, a, s, o, l, h) {
              ...
              if (h) (T = h[0]), (M = h[1]), (C = h[2]), (A = h[3]);
                ...
                (t = (u = g(t, e, -p)).x), (e = u.y), (o = (u = g(o, l, -p))
                  .x), (l = u.y);
                ...
                (T = t < C ? S - T : T), (M = o < C ? S - M : M), T < 0 &&
                  (T = 2 * S + T), M < 0 && (M = 2 * S + M), s &&
                  T > M &&
                  (T -= 2 * S), !s && M > T && (M -= 2 * S);
              }
              var E = M - T;
              if (B(E) > c) {
                ...
                (M = T + c * (s && M > T ? 1 : -1)), (o =
                  C + r * _.cos(M)), (l =
                  A + i * _.sin(M)), (d = Bt(o, l, r, i, n, 0, s, L, P, [
                  M,
                  N,
                  C,
                  A
            ...
            At = (e._path2curve = ht(
              function(t, e) {
                ...
                for (
                      ...
                      switch ((
                        ...
                        case "T":
                          "Q" == r || "T" == r
                            ...
                            : ((e.qx = e.x), (e.qy = e.y)), (t = ["C"][f](
                            kt(e.x, e.y, e.qx, e.qy, t[1], t[2])
                          ));
                          break;
                        case "Q":
                          (e.qx = t[1]), (e.qy = t[2]), (t = ["C"][f](
                  ...
                  i[x] && (d = i[x][0]), "C" != d &&
                    ((u[x] = d), x && (g = u[x - 1])), (i[x] = o(
                    i[x],
                    a,
                    g
                  )), "A" != u[x] && "C" == d && (u[x] = "C"), l(i, x), n &&
                    (
                      n[x] && (d = n[x][0]),
                      "C" != d && ((p[x] = d), x && (g = p[x - 1])),
                      (n[x] = o(n[x], s, g)),
                      "A" != p[x] && "C" == d && (p[x] = "C"),
                      l(n, x)
                    ), h(i, n, a, s, x), h(n, i, s, a, x);
                  var y = i[x],
                    m = n && n[x],
                    b = y.length,
                    _ = n && m.length;
                  (a.x = y[b - 2]), (a.y = y[b - 1]), (a.bx =
                    z(y[b - 4]) || a.x), (a.by = z(y[b - 3]) || a.y), (s.bx =
                    n && (z(m[_ - 4]) || s.x)), (s.by =
                    n && (z(m[_ - 3]) || s.y)), (s.x = n && m[_ - 2]), (s.y =
                    n && m[_ - 1]);
                }
            ...
            Mt = (
              ...
              (e._insertafter = function(t, e, r) {
                Tt(t, r), e == r.top && (r.top = t), e.next &&
                  (e.next.prev = t), (t.next =
                  e.next), (t.prev = e), (e.next = t);
              }),
              (e._insertbefore = function(t, e, r) {
                Tt(t, r), e == r.bottom && (r.bottom = t), e.prev &&
                  (e.prev.next = t), (t.prev =
            ...
            Et = (
              ...
              (e._extractTransform = function(t, r) {
                ...
                (t.matrix = u), (h.sx = o), (h.sy = l), (h.deg = s), (h.dx = i =
                  u.e), (h.dy = n = u.f), 1 == o && 1 == l && !s && h.bbox
            ...
            Lt = (e._equaliseTransform = function(t, r) {
              (r = x(r).replace(/\.{3}|\u2026/g, t)), (t =
                e.parseTransformString(t) || []), (r =
          ...
          (e._getContainer = function(t, r, i, n) {
          ...
          }), (e.pathToRelative = bt), (e._engine = {}), (e.path2curve = At), (e.matrix = function(
            t,
            e,
            r,
            i,
            ...
            (t.add = function(t, e, r, i, n, a) {
              ...
              for (
                t &&
                  t instanceof Pt &&
                  (f = [[t.a, t.c, t.e], [t.b, t.d, t.f], [0, 0, 1]]), s = 0;
                s < 3;
                s++
              )
                for (o = 0; o < 3; o++) {
              ...
              (this.a = u[0][0]), (this.b = u[1][0]), (this.c =
                u[0][1]), (this.d = u[1][1]), (this.e = u[0][2]), (this.f =
                u[1][2]);
            }), (t.invert = function() {
              var t = this,
                e = t.a * t.d - t.b * t.c;
              ...
              null == e && (e = t), (r || i) &&
                this.add(1, 0, 0, 1, r, i), this.add(t, 0, 0, e, 0, 0), (r ||
                i) &&
              ...
              (t.scalex = _.sqrt(r(n[0]))), i(n[0]), (t.shear =
                n[0][0] * n[1][0] + n[0][1] * n[1][1]), (n[1] = [
                n[1][0] - n[0][0] * t.shear,
                n[1][1] - n[0][1] * t.shear
              ]), (t.scaley = _.sqrt(r(n[1]))), i(n[1]), (t.shear /= t.scaley);
              var a = -n[0][1],
                s = n[1][1];
              return s < 0
                ? (
                ...
                : (t.rotate = e.deg(_.asin(a))), (t.isSimple = !(
                +t.shear.toFixed(9) ||
            ...
            var zt = function() {
              ...
              Dt = l.doc.addEventListener
                ? function(t, e, r, i) {
                        ...
                        for (
                          ...
                          if (e.targetTouches[s].target == t) {
                            ((e =
                              e.targetTouches[
                                s
                              ]).originalEvent = a), (e.preventDefault = Ft), (e.stopPropagation = jt);
                            break;
                          }
                    ...
                    return function() {
                      return t.removeEventListener(e, n, !1), p &&
                        m[e] &&
                        t.removeEventListener(m[e], a, !1), !0;
                    };
                  }
                : l.doc.attachEvent
                  ? function(t, e, r, i) {
                      var n = function(t) {
                        ...
                        return (t.preventDefault =
                          t.preventDefault || zt), (t.stopPropagation =
                          t.stopPropagation || Rt), r.call(i, t, a, s);
                      };
              ...
              Ot = function(e) {
                for (
                  ...
                  if (((r = qt[o]), p && e.touches)) {
                    for (var h, u = e.touches.length; u--; )
                      if ((h = e.touches[u]).identifier == r.el._drag.id) {
                        (i = h.clientX), (n = h.clientY), (e.originalEvent
                          ? e.originalEvent
                          : e).preventDefault();
                        break;
                      }
                  ...
                  var c,
                    ...
                    g = f.parentNode,
                    x = f.style.display;
                  l.win.opera && g.removeChild(f), (f.style.display =
                    "none"), (c = r.el.paper.getElementByPoint(
                    i,
                    n
                  )), (f.style.display = x), l.win.opera &&
                    (d ? g.insertBefore(f, d) : g.appendChild(f)), c &&
                    t(
                      "raphael.drag.over." + r.el.id,
                      r.el,
                      c
                    ), (i += s), (n += a), t(
          ...
          (Yt.data = function(r, i) {
            ...
            return null == t
              ? (G[this.id] = {})
              : G[this.id] && delete G[this.id][t], this;
          }), (Yt.getData = function() {
            return tt(G[this.id] || {});
          ...
          (Yt.drag = function(r, i, n, a, s, o) {
            function h(h) {
              ...
              (this._drag.x = u + d), (this._drag.y = c + f), !qt.length &&
                ...
                t.on("raphael.drag.move." + this.id, r), n &&
                t.on("raphael.drag.end." + this.id, n), t(
            ...
            var r = new he(t);
            return this.__set__ &&
              this.__set__.push(r), (r.paper = this), (r.type = "set"), r;
          ...
          (i.getElementByPoint = function(t, e) {
            ...
            for (; c.parentNode && c != u.parentNode && !c.raphael; )
              c = c.parentNode;
            return c == this.canvas.parentNode && (c = u), (c =
              c && c.raphael ? this.getById(c.raphaelid) : null);
                ...
                return (f.end = c), (u = t
                  ...
                  : r
                    ...
                    : e.findDotsAtSegment(
                        ...
                        l[5],
                        1
                      )).alpha && (u = { x: u.x, y: u.y, alpha: u.alpha }), u;
              };
            },
            $t = Ut(1),
            Zt = Ut(),
            Qt = Ut(0, 1);
          (e.getTotalLength = $t), (e.getPointAtLength = Zt), (e.getSubpath = function(
            t,
            e,
            r
          ) {
          ...
          (Jt.easeIn = Jt["ease-in"] = Jt["<"]), (Jt.easeOut = Jt["ease-out"] =
            Jt[">"]), (Jt.easeInOut = Jt["ease-in-out"] = Jt["<>"]), (Jt[
            "back-in"
          ] =
            Jt.backIn), (Jt["back-out"] = Jt.backOut);
          var Kt = [],
            te =
                        ...
                        if (c[o](b)) {
                          switch (I[b]) {
                            ...
                            default:
                              var S = [][f](c[b]);
                              for (
                                a = [], _ = x.paper.customAttributes[b].length;
                                _--;
                      ...
                      if (
                        (
                          (function(r, i, n) {
                            setTimeout(function() {
                              t(
                                "raphael.anim.frame." + i.id,
                                i,
                                n
                              ), t("raphael.anim.finish." + i.id, i, n), e.is(r, "function") && r.call(i);
                            });
                          })(n.callback, x, n.anim),
                          x.attr(d),
                          Kt.splice(i--, 1),
          ...
          function ae(r, i, a, s, l, h) {
            ...
            if (s)
              for (B = 0, C = Kt.length; B < C; B++) {
                ...
                if (k.el.id == i.id && k.anim == r) {
                  k.percent != a ? (Kt.splice(B, 1), (p = 1)) : (c = k), i.attr(
                    k.totalOrigin
                  );
                  break;
                }
            ...
            for (var B = 0, C = r.percents.length; B < C; B++) {
              if (r.percents[B] == a || r.percents[B] > s * r.top) {
                (a = r.percents[B]), (g = r.percents[B - 1] || 0), (m =
                  m / r.top * (a - g)), (d = r.percents[B + 1]), (u =
                  r.anim[a]);
                break;
              }
            ...
            if (u) {
              if (c) (c.initstatus = s), (c.start = new Date() - c.ms * s);
                  ...
                  if (u[o](S) && (I[o](S) || i.paper.customAttributes[o](S)))
                    switch ((
                      ...
                      case "transform":
                        ...
                        if (R)
                          for (
                            b[S] = R.from, _[S] = R.to, w[S] = [], w[
                              S
                            ].real = !0, B = 0, C = b[S].length;
                            B < C;
                            B++
                          )
                            for (
                              w[S][B] = [b[S][B][0]], N = 1, P = b[S][B].length;
                              N < P;
                              N++
                            )
                          ...
                          (b[S] = [D.a, D.b, D.c, D.d, D.e, D.f]), Et(
                            q,
                            _[S]
                          ), (_[S] = q._.transform), (w[S] = [
                            (q.matrix.a - D.a) / m,
                            (q.matrix.b - D.b) / m,
                            (q.matrix.c - D.c) / m,
                            (q.matrix.d - D.d) / m,
                      ...
                      default:
                        for (
                          O = [][f](u[S]), V = [][f](b[S]), w[S] = [], B =
                            i.paper.customAttributes[S].length;
                          B--;
                ...
                if (
                  ...
                  return ee();
                p && (k.start = new Date() - k.ms * s), 1 == Kt.length &&
                  te(ee);
              }
          ...
          (Yt.animateWith = function(t, r, i, n, a, s) {
            ...
            (!e.is(i, "function") && i) ||
              ((n = n || i || null), (i = null)), (t = Object(t)), (r =
              +r || 0);
            var a,
              s,
              l = {};
            for (s in t)
              t[o](s) &&
                ...
                ((a = !0), (l[s] = t[s]));
            if (a)
              return i && (l.easing = i), n && (l.callback = n), new ne(
                { 100: l },
                r
              );
            if (n) {
          ...
          return (ue.attr = function(t, r) {
            ...
            for (
              ...
              if (!this.items[n].removed) {
                ...
                t.push(a.x), e.push(a.y), r.push(a.x + a.width), i.push(
                  a.y + a.height
                );
              }
            return {
            ...
            if (
              ...
              for (var n in (
                (e.face["units-per-em"] = F(t.face["units-per-em"], 10)),
                t.glyphs
              ))
                if (t.glyphs[o](n)) {
                  var a = t.glyphs[n];
              ...
              return String(t).replace(oe, function(t, r) {
                return (function(t, e, r) {
                  ...
                  return e.replace(le, function(t, e, r, n, a) {
                    (e =
                      e ||
                      n), i && (e in i && (i = i[e]), "function" == typeof i && a && (i = i()));
                  }), (i = (null == i || i == r ? t : i) + "");
                })(t, r, e);
              });
            }
          ...
          if (!t || t.vml) {
                  ...
                  if (
                    ...
                    (m = m && m[0]), u.removeChild(m), h &&
                      ...
                      (m.size =
                        s.fillsize[0] * l(e) +
                        c +
                        s.fillsize[1] * l(r)), u.appendChild(m);
                  }
            ...
            var k,
              B = function(t, e, i) {
                ...
                (u[a + "arrow"] = o), (u[a + "arrowlength"] = l), (u[
                  a + "arrowwidth"
                ] = h);
              },
              C = function(n, l) {
                  ...
                  l.font && (R.font = l.font), l["font-family"] &&
                    (R.fontFamily =
                      ...
                      l["font-family"]
                        .split(",")[0]
                        .replace(/^['"]+|['"]+$/g, f) +
                      '"'), l["font-size"] && (R.fontSize = l["font-size"]), l[
                    "font-weight"
                ...
                if (
                  ...
                  if (
                    ...
                    if (I) {
                      j.parentNode == u &&
                        u.removeChild(j), (j.rotate = !0), (j.src =
                        I[1]), (j.type = "tile");
                      var D = n.getBBox(1);
                      (j.position = D.x + c + D.y), (n._.fillpos = [
                        D.x,
                        D.y
                      ...
                      (j.color = t.getRGB(l.fill).hex), (j.src = f), (j.type =
                ...
                if ("text" == A.type) {
                  ...
                  (v = H.style), g.font && (v.font = g.font), g[
                    "font-family"
                  ] && (v.fontFamily = g["font-family"]), g["font-weight"] &&
                    (v.fontWeight = g["font-weight"]), g["font-style"] &&
                    (v.fontStyle = g["font-style"]), (X =
                    i(g["font-size"] || (X && X[0])) || 10), (v.fontSize =
                    100 * X + "px"), A.textpath.string &&
                    (H.innerHTML = r(A.textpath.string)
                      .replace(/</g, "&#60;")
                      .replace(/&/g, "&#38;")
                      .replace(/\n/g, "<br>"));
                  var U = H.getBoundingClientRect();
                  (A.W = g.w = (U.right - U.left) / 100), (A.H = g.h =
                    (U.bottom - U.top) / 100), (A.X = g.x), (A.Y =
                    g.y + A.H / 2), ("x" in l || "y" in l) &&
                    (A.path.v = t.format(
                      "m{0},{1}l{2},{1}",
                      a(g.x * y),
                      a(g.y * y),
                  ...
                  switch (g["text-anchor"]) {
                    case "start":
                      (A.textpath.style["v-text-align"] = "left"), (A.bbx =
                        A.W / 2);
                      break;
                    case "end":
                      (A.textpath.style["v-text-align"] = "right"), (A.bbx =
                        -A.W / 2);
                      break;
                    default:
                      (A.textpath.style["v-text-align"] =
                        "center"), (A.bbx = 0);
                  }
              ...
              S = function(e, a, s) {
                ...
                if (((e = e.shape || e.node), p.length)) {
                  e.removeChild(s), (s.on = !0), (s.method = "none"), (s.color =
                    p[0].color), (s.color2 = p[p.length - 1].color);
              ...
              A = function(e, r) {
                (this[0] = this.node = e), (e.raphael = !0), (this.id = t._oid++), (e.raphaelid = this.id), (this.X = 0), (this.Y = 0), (this.attrs = {}), (this.paper = r), (this.matrix = t.matrix()), (this._ = {
                  ...
                  r.top), r.top &&
                  (r.top.next = this), (r.top = this), (this.next = null);
              },
              T = t.el;
            (A.prototype = T), (T.constructor = A), (T.transform = function(e) {
              ...
              if ((o.translate(1, 1), p || u || "image" == this.type))
                ...
                (h.style.filter = f), (l.matrix = r(
                  o
                )), (l.offset = o.offset());
              return null !== i &&
                ((this._.transform = i), t._extractTransform(this, i)), this;
              ...
              if (this.paper && this.paper._viewBoxShift) {
                ...
                return (e.x =
                  t.x - this.paper._viewBoxShift.dx), (e.x *= r), (e.y =
                  t.y - this.paper._viewBoxShift.dy), (e.y *= r), (e.width =
                  t.width * r), (e.height = t.height * r), (e.x2 =
                  e.x + e.width), (e.y2 = e.y + e.height), e;
              }
              return t;
            }), (T._getBBox = function() {
              return this.removed
              ...
              if (null == r) {
                ...
                return n.gradient &&
                  "none" == n.fill &&
                  (n.fill = n.gradient) &&
                  delete n.gradient, (n.transform = this._.transform), n;
              }
              ...
              if (f) {
                ...
                f.text &&
                  "text" == this.type &&
                  (this.textpath.string = f.text), C(this, f);
              }
              return this;
            }), (T.toFront = function() {
              return !this.removed &&
              ...
              var r = k("shape");
              (r.style.cssText = v), (r.coordsize = y + c + y), (r.coordorigin =
                e.coordorigin);
              var i = new A(r, e),
                n = { fill: "none", stroke: "#000" };
              t && (n.path = t), (i.type =
                "path"), (i.path = []), (i.Path = f), C(i, n), e.canvas &&
                e.canvas.appendChild(r);
              var a = k("skew");
              return (a.on = !0), r.appendChild(a), (i.skew = a), i.transform(
                f
              ), i;
              ...
              var o = t._rectPath(r, i, n, a, s),
                l = e.path(o),
                h = l.attrs;
              return (l.X = h.x = r), (l.Y = h.y = i), (l.W = h.width = n), (l.H = h.height = a), (h.r = s), (h.path = o), (l.type =
                "rect"), l;
            }), (t._engine.ellipse = function(t, e, r, i, n) {
              var a = t.path();
              a.attrs;
              return (a.X = e - i), (a.Y = r - n), (a.W = 2 * i), (a.H =
                2 * n), (a.type = "ellipse"), C(a, {
                cx: e,
                cy: r,
                rx: i,
                ry: n
              ...
              var n = t.path();
              n.attrs;
              return (n.X = e - i), (n.Y = r - i), (n.W = n.H =
                2 * i), (n.type = "circle"), C(n, { cx: e, cy: r, r: i }), n;
              ...
              return (h.src = r), (l.X = h.x = i), (l.Y = h.y = n), (l.W = h.width = a), (l.H = h.height = s), (h.path = o), (l.type =
                "image"), c.parentNode == u &&
                u.removeChild(c), (c.rotate = !0), (c.src = r), (c.type =
                "tile"), (l._.fillpos = [i, n]), (l._.fillsize = [
                a,
                s
              ]), u.appendChild(c), w(l, 1, 1, 0, 0, 0), l;
            }), (t._engine.text = function(e, i, n, s) {
              var o = k("shape"),
                l = k("path"),
                h = k("textpath");
              (i = i || 0), (n = n || 0), (s = s || ""), (l.v = t.format(
                "m{0},{1}l{2},{1}",
                a(i * y),
                a(n * y),
                a(i * y) + 1
              )), (l.textpathok = !0), (h.string = r(
                s
              )), (h.on = !0), (o.style.cssText = v), (o.coordsize =
                y + c + y), (o.coordorigin = "0 0");
              var u = new A(o, e),
                p = {
                  fill: "#000",
                  stroke: "none",
              ...
              (u.shape = o), (u.path = l), (u.textpath = h), (u.type =
                "text"), (u.attrs.text = r(
                s
              )), (u.attrs.x = i), (u.attrs.y = n), (u.attrs.w = 1), (u.attrs.h = 1), C(
                u,
                p
              ), o.appendChild(h), o.appendChild(l), e.canvas.appendChild(o);
              var d = k("skew");
              return (d.on = !0), o.appendChild(d), (u.skew = d), u.transform(
                f
              ), u;
            }), (t._engine.setSize = function(e, r) {
              var i = this.canvas.style;
              return (this.width = e), (this.height = r), e == +e &&
                (e += "px"), r == +r &&
                (r += "px"), (i.width = e), (i.height = r), (i.clip =
              ...
              return a &&
                (
                  ...
                  n * o < u && (r -= (u - n * o) / 2 / o)
                ), (this._viewBox = [e, r, i, n, !!a]), (this._viewBoxShift = {
                dx: -e,
                dy: -r,
                scale: l
              ...
              var o = new t._Paper(),
                ...
                h = l.style;
              return (a = a || 0), (s = s || 0), (n = n || 512), (i =
                i || 342), (o.width = n), (o.height = i), n == +n &&
                (n += "px"), i == +i && (i += "px"), (o.coordsize =
                216e5 + c + 216e5), (o.coordorigin =
                "0 0"), (o.span = t._g.doc.createElement(
                "span"
              )), (o.span.style.cssText =
                "position:absolute;left:-9999em;top:-9999em;padding:0;margin:0;line-height:1;"), l.appendChild(
                o.span
              ), (h.cssText = t.format(
                ...
                : r.firstChild
                  ...
                  : r.appendChild(l), (o.renderfix = function() {}), o;
            }), (t.prototype.clear = function() {
              t.eve(
                "raphael.clear",
                this
              ), (this.canvas.innerHTML = f), (this.span = t._g.doc.createElement(
                "span"
              )), (this.span.style.cssText =
                "position:absolute;left:-9999em;top:-9999em;padding:0;margin:0;line-height:1;display:inline;"), this.canvas.appendChild(
                this.span
            ...
            var x = function(i, n) {
              ...
              v = function(e, n) {
                ...
                if (!m) {
                  ...
                  if (
                    ...
                    (m = x(h + "Gradient", { id: u })), (e.gradient = m), x(
                      m,
                      "radial" == h
                        ? { fx: f, fy: p }
                        : {
                ...
                if ("path" == i.type) {
                  ...
                  if (
                    ...
                    a
                      ...
                      s) &&
                      (u.d = t.getSubpath(m.path, s, o)), x(y, u), (i._.arrows[
                      v + "Path"
                    ] = S), (i._.arrows[v + "Marker"] = A), (i._.arrows[
                      v + "dx"
                    ] = E), (i._.arrows[v + "Type"] = w), (i._.arrows[
                      v + "String"
                    ] = n);
                  } else
                    a
                      ...
                      x(y, { d: t.getSubpath(m.path, s, o) }), delete i._
                      .arrows[v + "Path"], delete i._.arrows[
                      v + "Marker"
                    ], delete i._.arrows[v + "dx"], delete i._.arrows[
                      v + "Type"
                ...
                for (var d in ((l.style.visibility = "hidden"), a))
                  if (a[e](d)) {
                    ...
                    switch (((u[d] = g), d)) {
                      ...
                      case "clip-rect":
                        ...
                        if (4 == S.length) {
                          ...
                          (A.id = t.createUUID()), x(T, {
                            ...
                            width: S[2],
                            height: S[3]
                          }), A.appendChild(T), i.paper.defs.appendChild(
                            A
                          ), x(l, {
                            "clip-path": "url(#" + A.id + ")"
                          }), (i.clip = T);
                      ...
                      case "stroke-width":
                        (1 == i._.sx && 1 == i._.sy) ||
                          (g /= s(o(i._.sx), o(i._.sy)) || 1), l.setAttribute(
                          d,
                          g
                        ), u["stroke-dasharray"] &&
                          w(i, u["stroke-dasharray"], a), i._.arrows &&
                          (
                            "startString" in i._.arrows &&
                              b(i, i._.arrows.startString),
                            "endString" in i._.arrows &&
                      ...
                      case "fill":
                        ...
                        if (P.error) {
                          ...
                          delete a.gradient, delete u.gradient, !t.is(
                            u.opacity,
                            "undefined"
                          ) &&
                            t.is(a.opacity, "undefined") &&
                            x(l, { opacity: u.opacity }), !t.is(
                            u["fill-opacity"],
                            "undefined"
                          ) &&
                      ...
                      case "stroke":
                        (P = t.getRGB(g)), l.setAttribute(d, P.hex), "stroke" ==
                          d &&
                          P[e]("opacity") &&
                          x(l, {
                            "stroke-opacity":
                ...
                if (
                  ...
                  if (a[e]("text")) {
                    ...
                    for (
                      ...
                      (h = x("tspan")), p &&
                        x(h, { dy: 1.2 * l, x: s.x }), h.appendChild(
                        t._g.doc.createTextNode(u[p])
                      ), o.appendChild(h), (f[p] = h);
                  } else
                    for (
              ...
              S = function(e, r) {
                (this[0] = this.node = e), (e.raphael = !0), (this.id = ("0000" +
                  ...
                  -5
                )), (e.raphaelid = this.id), (this.matrix = t.matrix()), (this.realPath = null), (this.paper = r), (this.attrs =
                  this.attrs || {}), (this._ = {
                  transform: [],
                  sx: 1,
                  sy: 1,
              ...
              A = t.el;
            (S.prototype = A), (A.constructor = S), (t._engine.path = function(
              t,
              e
            ) {
              var r = x("path");
              ...
              return i.nextSibling
                ...
                : i.parentNode.appendChild(r), t._insertafter(
                this,
                e,
                this.paper
              ), this;
              ...
              var r = C(this.node),
                i = C(e.node || e[0].node);
              return i.parentNode.insertBefore(r, i), t._insertbefore(
                this,
                e,
                this.paper
              ), this;
              ...
              if (0 != +e) {
                ...
                (r.attrs.blur = e), (i.id = t.createUUID()), x(n, {
                  stdDeviation: +e || 1.5
                }), i.appendChild(n), r.paper.defs.appendChild(
                  i
                ), (r._blur = i), x(r.node, { filter: "url(#" + i.id + ")" });
              } else
                r._blur &&
                  (
              ...
              }), s.setAttributeNS(p, "href", e), t.canvas &&
              ...
              return (this.width = t || this.width), (this.height =
                e || this.height), this.canvas.setAttribute(
                "width",
                this.width
              ), this.canvas.setAttribute("height", this.height), this
                ._viewBox && this.setViewBox.apply(this, this._viewBox), this;
              ...
              return (i = i || 0), (n = n || 0), (a = a || 512), x(l, {
                ...
                : (
                    ...
                    r.firstChild
                      ? r.insertBefore(l, r.firstChild)
                      : r.appendChild(l)
                  ), ((r = new t._Paper()).width = a), (r.height = s), (r.canvas = l), r.clear(), (r._left = r._top = 0), o &&
                (r.renderfix = function() {}), r.renderfix(), r;
              ...
              (this.bottom = this.top = null), (this.desc = x(
                "desc"
              )).appendChild(
                t._g.doc.createTextNode("Created with Raphaël " + t.version)
              ), e.appendChild(this.desc), e.appendChild(
                (this.defs = x("defs"))
              );
            }), (t.prototype.remove = function() {
              for (var e in (
    ...
    function(t, e, r) {
      ...
      (s = "hasOwnProperty"), (o = /[\.\/]/), (l = /\s*,\s*/), (h = function(
        t,
        e
      ) {
        return t - e;
      ...
      }), (p = Object.prototype.toString), (d = String), (g =
        Array.isArray ||
        function(t) {
