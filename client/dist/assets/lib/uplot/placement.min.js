...
var placement = (function() {
  ...
  return function(o, r, f, a, i) {
    void 0 === f && (f = "bottom"), void 0 === a && (a = "center"), void 0 ===
      i && (i = {}), (r instanceof Element || r instanceof Range) &&
    ...
    var l = getComputedStyle(o),
      ...
      b = {};
    for (var g in e)
      (m[g] = e[g]["top" === f || "bottom" === f ? 0 : 1]), (b[g] =
        e[g]["top" === f || "bottom" === f ? 1 : 0]);
    (o.style.position = "absolute"), (o.style.maxWidth =
      ""), (o.style.maxHeight = "");
    ...
    switch (a) {
      case "start":
        (o.style[b.before] = B + I(n[b.before] - d) + "px"), (o.style[b.after] =
          "auto");
        break;
      case "end":
        (o.style[b.before] = "auto"), (o.style[b.after] =
          B +
      ...
      default:
        ...
        (o.style[b.before] =
          B +
          I(n[b.before] + H / 2 - o[b.offsetSize] / 2 - d) +
          "px"), (o.style[b.after] = "auto");
    }
